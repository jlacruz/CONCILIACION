...
<form action='login' name="inicioSesion" id="inicioSesion" method="post" >
	<table class="table center-table table-nonfluid">
    	...
    	<tr>
                	<th>
            	<h2 class"form-signin" align="center">Iniciar Sesi&oacute;n</h2>
            </th>
        </tr>
        <tr>
...
<span class="input-group-addon glyphicon glyphicon-user"></span>
  <?php echo form_input(array('name' => 'usuario', 'id' => 'nombre', 'size' => '20', 'placeholder' => 'Usuario', 'class' => 'form-control','onkeyup' => 'javascript:this.value=this.value.toUpperCase()'  )) ?>                                        
</div>
         ...
         <tr>
				...
				<?php echo form_input(array('name' => 'clave', 'id' => 'clave', 'size' => '20', 'placeholder' => 'Clave', 'type' => 'password', 'class' => 'form-control','onkeyup' => 'javascript:this.value=this.value.toUpperCase()')) ?>
                </div>
            </td>
    ...
    <tr>
        ...
        <tr>
            <td style="text-align:center">
           		<a href="recuperarClave">Recuperar clave</a>
            </td>
        </tr>
    </table>
