...
<table class="table table-hover">
        ...
        <tr>
            <td align="justify"> <div><font color=white>_______</font>   Los Representantes  debidamente autorizados  por la  empresa <?php  echo  $v2_nom_empresa ?>
              y del MINISTERIO DEL PODER POPULAR PARA RELACIONES INTERIORES JUSTICIA Y PAZ, declaran que, analizados los antecedentes presentados por las partes en relaci&oacute;n 
              con los derechos y obligaciones en el per&iacute;odo <?php  echo  $periodo?>, por el servicio de <?php echo $v2_descripcion ?> en los diversos entes adscritos y las 
              oficinas pertenecientes a este ente Ministerial, resueltas las diferencias que se encontaron, asi como realizada la compensaci&oacute;n de derecchos y obligaciones entre 
              las partes con el fin de obtener el saldo deudor y acreedor respectivo se llego al acuerdo que el MINISTERIO DEL PODER POPULAR PARA RELACIONES INTERIORES JUSTICIA Y PAZ,
              deber&aacute; cancelar la deuda por Acreencia No preescrita a la empresa <?php  echo  $v2_nom_empresa ?>, ya que es un compromiso v&aacute;lidamente contra&iacute;do en 
              ejercicios fiscales anteriores. Por la cantidad de <?php  echo  $cambio  ?> (<?php  echo  $saldo ?> Bs)</div></td>
        </tr>
        ...
        <tr>
          <td align="justify"><div><font color=white>___</font> Se elaboran tres (3) ejemplares en la Ciudad de Caracas, en fecha <?php echo mdate($datestring) ?></div></td>
        </tr>
        <tr>
          <td align="left">&nbsp;</td>
        </tr>
        ...
        <tr>
          <td align="justify"><div><font color=white> __________</font>Organismo Acreedor <font color=white> ________________</font>Organismo Deudor </div></td>
        </tr>
        <tr>
            <td align="left"> <div align="center"><font color=white>_______</font></div></td>
        </tr>
