...
if ($resultados[0][0] != "") {
    ...
    foreach ($resultados as $resultado) {
      ...
      <td>" . $resultado[8] . "</td>
      <td>" . $resultado[13] . "</td>
      <td><a href='" . base_url() . "index.php/consulta_factura_controler2/MostrarDetalle?proveedores=". $proveedores ."&periodo=". $resultado[9] ."&f_numero=". $resultado[4] ."'> 
...
?>
        ...
        <p align="center"><a href="<?php echo base_url() ?>index.php/consulta_factura_controler2/gestion_factura" ><button type="button" class="btn btn-primary" align="center">Regresar</button></a></p>
