...
echo form_open('listarproveedorcontroler/buscarDatosproveedor', $attributes)
?>
<?php
...
<div id="body">
  ...
  <table class="table">
  <tr>
    <td height="54" colspan="6" bgcolor="#EBECEC"><h2 align="center">Consulta de Datos de Proveedores</h2></td>
  </tr>
  <tr>
 ...
 <!-- <tr>
  ...
  <tr>
    <td height="59" colspan="6" bordercolor="#EBECEC" ><div align="center">
            ...
            echo form_submit($atributosSubmit, 'Listar Todos')
            ?>
            <a href="<?php echo base_url() ?>index.php/consulproveedorcontroler/consultaModificar"><button type="button" class="btn btn-primary" align="center">Actualizar</button></a>
        </div>
        </br>
