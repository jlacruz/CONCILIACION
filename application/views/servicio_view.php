        ...
        <tr>
          <td height="49" ><div align="right" bgcolor="#EBECEC">
            ...
            <td colspan="2" >
              ...
              <div align="left">
                <input type="text" name="descripcion" size="20"  maxlength="40" required="required" class="form-control" placeholder="Nombre del Servicio" rule='blank', onkeyup = "this.value=this.value.toUpperCase()" required pattern="[A-Z\s]{3,18}"title="Campo de Texto">
