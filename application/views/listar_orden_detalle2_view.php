...
if ($resultados[0][0] != "") {
    ...
    foreach ($resultados as $resultado) {
      ...
      <td><a href='" . base_url() . "index.php/consulordencontroler2/MostrarDetalle?proveedores=". $proveedores ."&o_numero=". $resultado[3] ."'> 
...
?>
        ...
        <p align="center"><a href="<?php echo base_url() ?>index.php/consulordencontroler2/gestion_ordenpago" ><button type="button" class="btn btn-primary" align="center">Regresar</button></a></p>
