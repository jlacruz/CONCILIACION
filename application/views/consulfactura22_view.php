...
echo form_open('consulta_factura_controler2/actualizar_factura', $attributes)
?>
<?php
$nom_empresa = array(
    'name' => 'nom_empresa',
    ...
    <div class="table-responsive">
        <table class="table">
            ...
            <td><div class="radio" align="right">
                    <label>
                        <input class='estatus' type="hidden" name="estatus" id="estatus_1" value="1" checked disabled>
            ...
            <td><div class="radio" align="right">
                    <label>
                        <input class='estatus' type="hidden" name="estatus" id="estatus_2" value="0" disabled >
                        <FONT COLOR="red"></FONT>
                  </label>
