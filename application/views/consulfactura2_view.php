...
$mes = array(
    ...
    'title'=>'Ingrese la Opci&oacute;n S&oacute;lo como se lo muestra la lista autocompletable (tres letras)',
    'onkeyup' => 'javascript:this.value=this.value.toUpperCase()'
);
$f_numero = array(
    'name' => 'f_numero',
    ...
    <div class="table-responsive">
        <table class="table">
            ...
            <tr>
                ...
                <td><div align="left"><?php echo form_input($fecha_carga) ?></div></td>
