...
<div id="body">
  ...
  <table class="table">
        ...
        <tr>
          ...
          <td width="12%" bordercolor="#EBECEC" ><div align="right">C&oacute;d. Proveedor: </div></td>
            <td width="22%" bordercolor="#EBECEC" align="left"><div align="left"><?php echo form_input($cod_proveedor) ?></div></td>
        ...
        <tr>
            ...
            <td bordercolor="#EBECEC"><div align="left"></div></td>
            <td bordercolor="#EBECEC">&nbsp;</td>
            <td bordercolor="#EBECEC">&nbsp;</td>
        </tr>
        <tr>
  ...
  <table class="table" id='tabla'>  
        ...
        <tr>
            ...
            <td width="86" bordercolor="#EBECEC" ><input  id="o_monto" name="o_monto[]" type="text"  value="" size="10" maxlength="15" required="required" placeholder = "Ej: 0.00" required pattern="[0-9]{2,18}[.]{1}[0-9]{2}"  title='Expresar los montos con punto y dos cifras Decimales (Ej:1.00)'/></div></td>
...
<script>
    $(document).on("blur", '#o_numero', function ()
    {
        ...
        $.ajax({
            ...
            data: {id_proveedor: $('#proveedores').val(), o_numero: $(this).val()},
            dataType: 'html',
            type: 'post',
            success: function (salida) {
                //alert(salida); 
...
if(!isNaN(num)){
//num = num.toString().split('').reverse().join('').replace(/(?=\d*\.?)(\d{3})/g,'$1 ','$2 ');
//num = num.toString().split('').reverse().join('').replace( /\B(?=(?:\d{3})+)$/g, "$1," );
