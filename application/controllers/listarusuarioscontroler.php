...
class Listarusuarioscontroler extends CI_Controller {
    ...
    public function buscarDatos() {
        ...
        $datos_usuario = $this->pmodel->consultas('usuarios_todos', $arrayData1);
        //print_r($datos_usuario );
        
        $cantidadTuplas = $this->pmodel->consultas('contar_usuario', $arrayData);// funcion que cuenta la cantidad de registros de la tabla
...
//======================================================================================================//	
    public function MostrarDetalle() {
        ...
        $arrayData[] = $cedula;
        $this->db_conciliacion = $this->load->database('default', true);
        $datos_funcionario = $this->pmodel->consultas('buscar_usuario', $arrayData);
